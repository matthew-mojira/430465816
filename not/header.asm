...
ORG $00FFB0    
    ...
    db     "CMSC 430 COMPILERS   "    ; GAME TITLE (21 Bytes)
...
I_RESET:
    ...
    ROL $420D    ; rotate left cycle speed designation (3.58MHz --> 2.68MHz?)     Technically this seems to be overwritten by ClearRegs
    JML F_RESET
F_RESET:
